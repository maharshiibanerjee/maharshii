...
SQL> Insert into Customers values(000001,'Chris Hemsworth',' Elsa Pataky',' Prenzlauer Berg 665','Berlin','Germany');

SQL> insert into Customers values(000002,'Chris Evans','Shanna Evans','Boston,Massachusetts, United States','Mexico');

SQL> insert into Customers values(000003,'Antonio Moreno','Antonio Moreno','Mataderos 2312','México D.F.','Mexico');
