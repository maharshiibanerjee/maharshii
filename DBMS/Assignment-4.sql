...
insert into SAILORS_40 values(10,'Rishi',10,25);
insert into SAILORS_40 values(20,'Panda',9,27);
insert into SAILORS_40 values(30,'Rano',7,65);
BOATS TABLE:-

insert into BOATS values(101,'Senora','Red');
insert into BOATS values(102,'Nauti','Green');
insert into BOATS values(103,'Xartan','Blue');
...
insert into TEACHER values(001,'SS','CSE');
insert into TEACHER values(002,'AD','ECE');
insert into TEACHER values(003,'DM','CSE');

SUBJECT TABLE:-

insert into SUBJECT values(101,'DBMS');
insert into SUBJECT values(102,'String');
...
insert into STUDENT values(20,'Rik','Kolkata');
insert into STUDENT values(26,'Aakash','Konnagar');
insert into STUDENT values(30,'Probad','Jadavpur ');
insert into STUDENT values(32,'Kirsh','Birbhum');


QUERIES:


select color from BOATS,SAILORS,RESERVES where S_name like 'Rishi' and SAILORS.S_id=RESERVES.S_id and BOATS.B_id=RESERVES.B_id;
...
where Teacher.Dept like 'CSE' and 
Subject.Subtitle like 'String' and
